...
function resetDieImage() {
    ...
    $('#dice1').attr({src: "img/question_side_die" + imgSize + ".png", alt: "?"});
    $('#dice2').attr({src: "img/question_side_die" + imgSize + ".png", alt: "?"});
}
...
function placeDieImage(dice, number) {
    var imgSize = getScreenSize();
    if(number == 1) {
        $(dice).attr({src: "img/one_side_die" + imgSize + ".png", alt: "1"});
    } else if (number == 2) {
        $(dice).attr({src: "img/two_side_die" + imgSize + ".png", alt: "2"});
    } else if (number == 3) {
        $(dice).attr({src: "img/three_side_die" + imgSize + ".png", alt: "3"});
    } else if (number == 4) {
        $(dice).attr({src: "img/four_side_die" + imgSize + ".png", alt: "4"});
    } else if (number == 5) {
        $(dice).attr({src: "img/five_side_die" + imgSize + ".png", alt: "5"});
    } else {
        $(dice).attr({src: "img/six_side_die" + imgSize + ".png", alt: "6"});
    }
}

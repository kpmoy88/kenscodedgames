...
// Sets dice images to Question Die Image
function resetDieImage() {
    var imgSize = getScreenSize();
    $('#dice1').attr({src: "<%= asset_path('question_side_die" + imgSize + ".png') %>", alt: "?"});
    $('#dice2').attr({src: "<%= asset_path('question_side_die" + imgSize + ".png') %>", alt: "?"});
}
...
function placeDieImage(dice, number) {
    var imgSize = getScreenSize();
    if(number == 1) {
        $(dice).attr({src: "<%= asset_path('one_side_die" + imgSize + ".png') %>", alt: "1"});
    } else if (number == 2) {
        $(dice).attr({src: "<%= asset_path('two_side_die" + imgSize + ".png') %>", alt: "2"});
    } else if (number == 3) {
        $(dice).attr({src: "<%= asset_path('three_side_die" + imgSize + ".png') %>", alt: "3"});
    } else if (number == 4) {
        $(dice).attr({src: "<%= asset_path('four_side_die" + imgSize + ".png') %>", alt: "4"});
    } else if (number == 5) {
        $(dice).attr({src: "<%= asset_path('five_side_die" + imgSize + ".png') %>", alt: "5"});
    } else {
        $(dice).attr({src: "<%= asset_path('six_side_die" + imgSize + ".png') %>", alt: "6"});
    }
}
